...
template double moment( BIN_TYPE* histogram , ABSCISSE_TYPE* bins , uint n_bins , uint exp , uint64_t n_total , int n_threads , bool no_clip ); \
...
template double centered_moment( BIN_TYPE* histogram , ABSCISSE_TYPE* bins , uint n_bins , uint exp , uint64_t n_total , int n_threads , bool no_clip ); \
